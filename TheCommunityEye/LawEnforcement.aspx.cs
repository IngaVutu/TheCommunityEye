...
{
    public partial class LawEnforcement : System.Web.UI.Page
    {
        ...
        private void BindCases(string sortExpression = null)
        {
            ...
            {
                string query = "SELECT CaseID, CrimeType, Area, Evidence, Recency, ReportDate, PlaintiffID, OfficerID, Status_ FROM CrimeCase";
